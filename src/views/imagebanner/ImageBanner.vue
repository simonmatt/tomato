  ...
  <div class="imageBanner">
    ...
    <div class="details">
      ...
      <div class="zan" :class="{selected: isSelected}">
        ...
        <span>{{ imageInfo.collections_count }}</span> Likes
      </div>
      <textarea class="postComment" v-model="comment" placeholder="Add comment here..." autofocus @keyup.enter="postComment"></textarea>
    </div>
